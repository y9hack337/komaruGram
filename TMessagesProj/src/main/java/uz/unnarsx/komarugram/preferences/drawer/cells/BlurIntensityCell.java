...
public class BlurIntensityCell extends FrameLayout {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText("" + komarugramAppearanceConfig.INSTANCE.getDrawerBlurIntensity(), getMeasuredWidth() - AndroidUtilities.dp(39), AndroidUtilities.dp(28), textPaint);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        sizeBar.setProgress((komarugramAppearanceConfig.INSTANCE.getDrawerBlurIntensity() - startIntensity) / (float) (endIntensity - startIntensity));
    }
