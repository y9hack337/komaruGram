...
import uz.unnarsx.komarugram.chats.helpers.StickersHelper
...
import uz.unnarsx.komarugram.preferences.string

object komarugramChatsConfig: CoroutineScope by CoroutineScope(
    ...
    const val CHATGPT = 0
    const val GEMINI = 1
    const val BLACKBOX = 2
    var GPTMODEL by sharedPreferences.int("CP_AiModel", CHATGPT)
    ...
    init {
        ...
        launch {
            if (!komarugramCoreConfig.isPlayStoreBuild()) StickersHelper.getStickerSetIDs()
