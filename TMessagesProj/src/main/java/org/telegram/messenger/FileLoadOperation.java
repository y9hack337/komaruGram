...
public class FileLoadOperation {
    ...
    private void updateParams() {
        if ((komarugramExperimentalConfig.INSTANCE.getDownloadSpeedBoost() == komarugramExperimentalConfig.BOOST_AVERAGE || (preloadPrefixSize > 0 || MessagesController.getInstance(currentAccount).getfileExperimentalParams)) && !forceSmallChunk) {
            downloadChunkSizeBig = 1024 * 512;
            maxDownloadRequests = 8;
            maxDownloadRequestsBig = 8;
        } else if (komarugramExperimentalConfig.INSTANCE.getDownloadSpeedBoost() == komarugramExperimentalConfig.BOOST_EXTREME) {
