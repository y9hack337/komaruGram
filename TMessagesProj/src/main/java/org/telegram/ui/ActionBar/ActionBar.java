...
public class ActionBar extends FrameLayout {
    ...
    private boolean castShadows = !komarugramAppearanceConfig.INSTANCE.getDisableToolBarShadow();
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (supportsHolidayImage && !titleOverlayShown && !LocaleController.isRTL && (child == titleTextView[0] || child == titleTextView[1] || child == titlesContainer && useContainerForTitles)) {
            ...
            if (drawable != null) {
                ...
                if (Theme.canStartHolidayAnimation() || komarugramAppearanceConfig.INSTANCE.getDrawSnowInActionBar()) {
                    if (snowflakesEffect == null) {
                        snowflakesEffect = new SnowflakesEffect(0);
                    }
                } else if (!manualStart) {
    ...
    private void createSubtitleTextView() {
        ...
        subtitleTextView.setGravity(komarugramAppearanceConfig.INSTANCE.getCenterTitle() ? Gravity.CENTER : Gravity.LEFT);
    ...
    public void createAdditionalSubtitleTextView() {
        ...
        additionalSubtitleTextView.setGravity(komarugramAppearanceConfig.INSTANCE.getCenterTitle() ? Gravity.CENTER : Gravity.LEFT);
    ...
    private void createTitleTextView(int i) {
        ...
        titleTextView[i].setGravity(komarugramAppearanceConfig.INSTANCE.getCenterTitle() ? Gravity.CENTER : Gravity.LEFT | Gravity.CENTER_VERTICAL);
...
//        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < 2; i++) {
            if (titleTextView[0] != null && titleTextView[0].getVisibility() != GONE || subtitleTextView != null && subtitleTextView.getVisibility() != GONE) {
                int availableWidth = komarugramAppearanceConfig.INSTANCE.getCenterTitle() ? (width - dp(120)) : width - (menu != null ? menu.getMeasuredWidth() : 0) - dp(16) - textLeft - titleRightMargin;
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        for (int i = 0; i < 2; i++) {
            if (titleTextView[i] != null && titleTextView[i].getVisibility() != GONE) {
                ...
                if (komarugramAppearanceConfig.INSTANCE.getCenterTitle()) {
    ...
    public void setCastShadows(boolean value) {
        if (komarugramAppearanceConfig.INSTANCE.getDisableToolBarShadow()) return;
...
//                String countString = count > 99 ? "99+" : Integer.toString(count);
    ...
    public void unreadBadgeSetCount(int count) {
        if (backButtonImageView != null && komarugramChatsConfig.INSTANCE.getUnreadBadgeOnBackButton()) {
