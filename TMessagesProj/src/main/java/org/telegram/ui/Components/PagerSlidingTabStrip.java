...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private void addTab(final int position, CharSequence text) {
        ...
        Theme.setRippleDrawableForceSoftware(rippleDrawable);
        if (tabStyle < komarugramAppearanceConfig.TAB_STYLE_VKUI) tab.setBackground(rippleDrawable);
        tab.setText(text);
        tab.setOnClickListener(v -> {
            if (pager.getAdapter() instanceof IconTabProvider) {
                if (!((IconTabProvider) pager.getAdapter()).canScrollToTab(position)) {
        ...
        if (currentTab != null) {
            ...
            if (indicatorHeight != 0) {
                ...
                if (tabStyle != komarugramAppearanceConfig.TAB_STYLE_TEXT) {
                    if (tabStyle >= komarugramAppearanceConfig.TAB_STYLE_VKUI) {
                        rectPaint.setAlpha(0x2F);
                        int sideBound = (tabStyle == komarugramAppearanceConfig.TAB_STYLE_VKUI ? AndroidUtilities.dp(8) : tabStyle == komarugramAppearanceConfig.TAB_STYLE_PILLS ? AndroidUtilities.dp(10) : 0);
                        AndroidUtilities.rectTmp.set(
                                lineLeft - sideBound, tabStyle >= komarugramAppearanceConfig.TAB_STYLE_VKUI ? height / 2 - AndroidUtilities.dp(tabStyle == komarugramAppearanceConfig.TAB_STYLE_VKUI ? 14 : 15) : (height - indicatorHeight),
                                lineRight + sideBound, tabStyle >= komarugramAppearanceConfig.TAB_STYLE_VKUI ? height / 2 + AndroidUtilities.dp(tabStyle == komarugramAppearanceConfig.TAB_STYLE_VKUI ? 14 : 15) : height
                        );
                    }
                    float r = tabStyle == komarugramAppearanceConfig.TAB_STYLE_VKUI ? AndroidUtilities.dp(8) : tabStyle == komarugramAppearanceConfig.TAB_STYLE_PILLS ? AndroidUtilities.dp(30) : indicatorHeight / 2f;
