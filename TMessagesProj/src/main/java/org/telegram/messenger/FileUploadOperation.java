...
public class FileUploadOperation {
    ...
    public void start() {
        ...
        Utilities.stageQueue.postRunnable(() -> {
            ...
            slowNetwork = komarugramExperimentalConfig.INSTANCE.getSlowNetworkMode();
...
//                }
                ...
                uploadChunkSize = (int) Math.max(slowNetwork ? minUploadChunkSlowNetworkSize : komarugramExperimentalConfig.INSTANCE.getUploadSpeedBoost() ? minUploadChunkSizeBoost : minUploadChunkSize, (totalFileSize + 1024L * maxUploadParts - 1) / (1024L * maxUploadParts));
