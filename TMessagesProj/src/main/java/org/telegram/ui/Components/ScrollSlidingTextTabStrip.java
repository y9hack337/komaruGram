...
public class ScrollSlidingTextTabStrip extends HorizontalScrollView {
    ...
    public void addTextTab(final int id, CharSequence text, SparseArray<View> viewsCache) {
        ...
        if (tab == null) {
            ...
            if (tabStyle < komarugramAppearanceConfig.TAB_STYLE_VKUI) tab.setBackground(Theme.createSelectorDrawable(Theme.multAlpha(processColor(Theme.getColor(activeTextColorKey, resourcesProvider)), 0f), 3));
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (child == tabsContainer) {
            ...
            selectorDrawable.setAlpha((int) (tabStyle >= komarugramAppearanceConfig.TAB_STYLE_VKUI ? 50 : 255 * tabsContainer.getAlpha()));
            float x = indicatorX + indicatorXAnimationDx;
            float w = x + indicatorWidth + indicatorWidthAnimationDx;
            selectorDrawable.setBounds(
                    (int) x - (tabStyle == komarugramAppearanceConfig.TAB_STYLE_VKUI ? AndroidUtilities.dp(8) : tabStyle == komarugramAppearanceConfig.TAB_STYLE_PILLS ? AndroidUtilities.dp(10) : 0),
                    tabStyle >= komarugramAppearanceConfig.TAB_STYLE_VKUI ? height / 2 - AndroidUtilities.dp(15) : height - AndroidUtilities.dp(4),
                    (int) w + (tabStyle == komarugramAppearanceConfig.TAB_STYLE_VKUI ? AndroidUtilities.dp(8) : tabStyle == komarugramAppearanceConfig.TAB_STYLE_PILLS ? AndroidUtilities.dp(10) : 0),
                    tabStyle >= komarugramAppearanceConfig.TAB_STYLE_VKUI ? height / 2 + AndroidUtilities.dp(15) : height
            );
